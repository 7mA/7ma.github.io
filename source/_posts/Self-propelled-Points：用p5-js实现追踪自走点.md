...
简单的生成逻辑不光造成了生成的地图不够细腻精良的结果，而且还有出现导致不巧开场直接就被四个墙壁围起来，或者出生点旁边就是敌人这种开局即死的局面。此外还有敌人在两条相距很近的平行墙壁之间生成，导致敌人无法动弹的问题。
...
另外还有难度递增函数、敌人随机生成位置、UI等仍然值得精雕细琢的地方，不过这些地方的改良应该需要在随机地图问题解决以后再做考量。
