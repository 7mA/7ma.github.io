...
<picture>
    <source type="image/webp" srcset="/javascript-code-reuse/intersection-1.webp">
    <source type="image/png" srcset="/javascript-code-reuse/intersection-1.min.png">
    <img src="/javascript-code-reuse/intersection-1.min.png" alt="不相交的线段" />
</picture>

下图的线段`g`与线段`f`所在直线`h`的交点为`P`，但是线段`f`和线段`g`也不相交。

<picture>
    <source type="image/webp" srcset="/javascript-code-reuse/intersection-2.webp">
    <source type="image/png" srcset="/javascript-code-reuse/intersection-2.min.png">
    <img src="/javascript-code-reuse/intersection-2.min.png" alt="线段与直线相交" />
</picture>

下图当中的线段`g`与线段`f`相交，交点为`P`。

<picture>
    <source type="image/webp" srcset="/javascript-code-reuse/intersection-3.webp">
    <source type="image/png" srcset="/javascript-code-reuse/intersection-3.min.png">
    <img src="/javascript-code-reuse/intersection-3.min.png" alt="线段相交" />
</picture>
...
但是程序的设计就是一点点累积的，小处井井有条，才有能变大的那一天。
